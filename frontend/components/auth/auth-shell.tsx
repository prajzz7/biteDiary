...
const memories = [
  {
    ...
    detail: "Asian / Mumbai",
    rating: "4.8",
    note: "Ramen worth repeating",
  },
  {
    place: "Roast Room",
    detail: "Cafe / Colaba",
    rating: "4.7",
    note: "Best rainy evening coffee",
  },
  {
    place: "The Daily Bowl",
    detail: "Healthy / Bandra",
    rating: "4.6",
    note: "Weekday lunch favorite",
  },
];
            ...
            <div className="w-full">
              ...
              <div className="mt-8 max-w-xl">
                <div className="mb-3 flex items-center justify-between">
                  <h2 className="text-sm font-bold uppercase text-ink-secondary">
                    Recent highlights
                  </h2>
...
function StatTile({
  ...
  return (
    <div className="rounded-card border border-border bg-surface p-3 shadow-card">
      ...
      <p
        className={`${compact ? "text-xl" : "text-2xl"} mt-1 font-display font-semibold text-ink-primary`}
      >
        {value}
      </p>
    </div>
    ...
    <article className="grid grid-cols-[48px_minmax(0,1fr)_auto] items-center gap-3 rounded-card border border-border bg-surface p-3 shadow-card">
      ...
      <div className="min-w-0">
        <div className="flex min-w-0 items-center gap-2">
          ...
          <p className="hidden truncate text-xs font-semibold text-ink-secondary sm:block">
            {detail}
          </p>
        </div>
...
function BrandMark({ compact = false }: { compact?: boolean }) {
  return (
    ...
    >
      ...
      <span
        className={`${compact ? "text-lg" : "text-xl"} font-display font-semibold text-ink-primary`}
      >
        BiteDiary
      </span>
    </Link>
